...
return [
    ...
    'positions_ip_log' => env('POSITIONS_IP_LOG', true),
    ...
    'main_settings' => [
        ...
        'server_description' => 'GPS Tracking System',
        'available_maps' => [
            "2"  => 2,
            "51"  => 51,
            "53"  => 53,
    ...
    'process' => [
        ...
        'insert_limit' => env('PROC_INSERT_LIMIT', 60),
        'reportdaily_timeout' => env('PROC_REPORT_TIMEOUT', 360),
        'reportdaily_limit' => env('PROC_REPORT_LIMIT', 8),
        'send_event_timeout' => env('PROC_SEND_EVENT_TIMEOUT', 240),
        'send_event_limit' => env('PROC_SEND_EVENT_LIMIT', 6),
        'send_event_take' => env('PROC_SEND_EVENT_TAKE', 150),
    ],
