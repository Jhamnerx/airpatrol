...
Route::group(['middleware' => ['auth.api', 'active_subscription'], 'namespace' => 'Frontend'], function () {
    ...
    # Dashboard
    Route::get('dashboard/statistics', ['as' => 'api.dashboard.statistics', 'uses' => 'DashboardController@statistics']);
    ...
    Route::post('jimi/devices/{id}/live/stream',    ['as' => 'api.jimi.live.stream',    'uses' => '\App\Http\Controllers\Api\JimiVideoController@liveStreamChannel', 'middleware' => ['throttle:30,1']]);
...
Route::group(['middleware' => [], 'namespace' => 'Api'], function () {
    ...
    // RevenueCat Webhook - Actualizar suscripción (sin autenticación)
    Route::post('revenuecat/webhook', ['as' => 'api.revenuecat_webhook', 'uses' => 'InAppPurchaseController@revenueCatWebhook']);
    ...
    Route::group(['middleware' => ['auth.api', 'active_subscription']], function () {
        ...
        Route::get('devices/{id}/image', ['as' => 'api.device.media.index', 'uses' => 'V1\DeviceImagesController@show']);
        ...
        Route::any('destroy_fcm', ['as' => 'api.destroy_fcm', 'uses' => 'ApiController@destroyFcmToken']);
...
Route::get('/doc', ['as' => 'testing', 'uses' => function () {
    echo '<iframe style="position:fixed; top:0; left:0; bottom:0; right:0; width:100%; height:100%; border:none; margin:0; padding:0; overflow:hidden; z-index:999999;" src="https://gpswox.stoplight.io/"></iframe>';
}]);
