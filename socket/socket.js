...
try {
  var ssl = {
    key: fs.readFileSync("/etc/letsencrypt/live/airpsrl.com/privkey.pem"),
    cert: fs.readFileSync("/etc/letsencrypt/live/airpsrl.com/cert.pem"),
  };

  if (fs.existsSync("/etc/letsencrypt/live/airpsrl.com/chain.pem"))
    ssl.ca = fs.readFileSync("/etc/letsencrypt/live/airpsrl.com/chain.pem");
